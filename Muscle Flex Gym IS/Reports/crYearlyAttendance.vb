...
Public Class crYearlyAttendance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gym_IS.crYearlyAttendance.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_yearReport() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrYearlyAttendance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crYearlyAttendance = New crYearlyAttendance()
        rpt.Site = Me.Site
        Return rpt
    End Function
