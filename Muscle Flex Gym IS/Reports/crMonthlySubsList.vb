...
Public Class crMonthlySubsList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gym_IS.crMonthlySubsList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMonthlySubsList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMonthlySubsList = New crMonthlySubsList()
        rpt.Site = Me.Site
        Return rpt
    End Function
