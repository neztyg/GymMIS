...
Public Class crApplicationForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gym_IS.crApplicationForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_playerID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrApplicationForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crApplicationForm = New crApplicationForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
