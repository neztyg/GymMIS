...
Public Class crTransactionDaily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gym_IS.crTransactionDaily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrTransactionDaily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTransactionDaily = New crTransactionDaily()
        rpt.Site = Me.Site
        Return rpt
    End Function
