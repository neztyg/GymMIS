...
Public Class crClientSalesDaily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gym_IS.crAttendancebyDate.rpt"
        End Get
        Set(ByVal value As String)
            'Do nothing
        End Set
    ...
    <Browsable(False), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_logDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrClientSalesDaily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAttendancebyDate = New crAttendancebyDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
